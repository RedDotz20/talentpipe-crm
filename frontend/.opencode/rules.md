...
- **TanStack Router 1** — file-based routing is NOT used. Routes are defined in `src/app/router.tsx` using `createRootRoute`, `createRoute`, `createRouter`. Use `@tanstack/react-router`.
